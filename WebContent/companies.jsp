...
<c:forEach var="row" items="${result.rows}">
    <a href="company_info.jsp?company_id=${row.company_id}&company_name=${row.company_name}"><img src="${row.company_logo}" class="img-thumbnail"></a>&nbsp;
</c:forEach>

<br><br><br>

<h2 class="lined-heading">
<span>Previous Companies</span></h2>
